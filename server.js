...
app.get('/actor', async (req, res) => {
    ...
    try {
        ...
        const totalActors = await Actor.count({
            // Include any specific conditions here if needed
            // For example, to count only actors with first names starting with 'A'
            // where: {
            //     first_name: {
            //         [Op.like]: 'A%'
            //     }
        ...
        // Send response with actors data and total pages
        res.json({
            data: actors,
